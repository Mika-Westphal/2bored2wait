...
4. Run `npm install`
5. When you want to use a file based auto login go to 5. But if you want to enter your Minecraft informations everytime you start the program ignore 5 and go to 6.
